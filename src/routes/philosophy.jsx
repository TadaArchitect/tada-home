    ...
    <main>
        ...
        <div className="concept">
            ...
            <div className="concept-text">
                ...
                <p>光・緑・風を五感で感じること</p>
                <p className="lewis">人間として本当に心地よい空間・・・
                    あたりまえはあたりまえではない
                    じっくりと、ゆっくりと
                    時間と空間は変化しつづける
                    日本人が本来もつ感性
        ...
        <div className="housing-design">
            <div className="housing-design-box">
                ...
                <p><span className="housing-design-text">「家」</span>は家族が集まり、社会で疲れた体を癒し、再生する場所です。ですから、仕上げなど体にふれる部分の材料にはこだわり、無垢の木や自然塗料、珪藻土等の体にやさしいものを中心に使用します。また、外部空間には出来る限り多くの植栽を設け、それが建物内部にもとりいれられる様なプラン作りを心がけています。</p>
                <p><span className="housing-design-text">「敷地」</span>も建物を配置していく上で大変重要な要素の1つです。私共にとっては、1つの敷地に対して、いくつものプランを考えます。しかし、その敷地の特性を最大限に生かせるものはいくつでもあるわけではなく、また正解というものもありません。一番なにを優先させるかにもよりますが、「この敷地だからありえるのだ。」といえるものを目指しています。</p>
                <p><span className="housing-design-text">「設計事務所」</span>というと敷居が高いとお考えの方が多いと思いますが、私共はそのようなことはなく、何でも気軽に相談できる事務所づくりを目指しています。相談事は、玄関に置くプランターの花のことでもいいのです。家は買うものではなく、建築家と一緒につくっていくもの。そしてメンテナンスなどで一生おつきあいしていくもの。となるでしょう。</p>
            </div>
