    ...
    <main>
      ...
      <div className="concept">
        ...
        <div className="concept-text">
          ...
          <p>光・緑・風を五感で感じること</p>
          <p className="lewis">
            人間として本当に心地よい空間・・・ あたりまえはあたりまえではない
            じっくりと、ゆっくりと 時間と空間は変化しつづける
            日本人が本来もつ感性 それはそれは豊かなもの Wabi-Sabi
            大切に残していきたい "How marvelous that when I am in a room with
            another. The mountains, trees, wind, and rain leave us for the mind,
            and the room be come a world in itself."
            「部屋の中に、他の人と一緒にいることは、何と素晴らしいことか、
            その時、山も木も風も雨も心の中のものとなり、
            部屋はそれ自体が一つの世界になる。」
          </p>
          <p className="lewis">ルイス・カーン</p>
        </div>
      </div>
      ...
      <div className="housing-design">
        <div className="housing-design-box">
          <h2>●住宅設計に対する考え方</h2>
          <p>
          ...
          <p>
            <span className="housing-design-text">「家」</span>
          ...
          <p>
            <span className="housing-design-text">「敷地」</span>
            も建物を配置していく上で大変重要な要素の1つです。私共にとっては、1つの敷地に対して、いくつものプランを考えます。しかし、その敷地の特性を最大限に生かせるものはいくつでもあるわけではなく、また正解というものもありません。一番なにを優先させるかにもよりますが、「この敷地だからありえるのだ。」といえるものを目指しています。
          </p>
          <p>
            <span className="housing-design-text">「設計事務所」</span>
            というと敷居が高いとお考えの方が多いと思いますが、私共はそのようなことはなく、何でも気軽に相談できる事務所づくりを目指しています。相談事は、玄関に置くプランターの花のことでもいいのです。家は買うものではなく、建築家と一緒につくっていくもの。そしてメンテナンスなどで一生おつきあいしていくもの。となるでしょう。
          </p>
        </div>
        <div className="housing-design-img">
          <p>
            <img src="images/housing-design.jpg" alt="" />
          </p>
        </div>
      </div>
    </main>
