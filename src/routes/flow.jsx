        ...
        <div className="flow-box">
          <div className="flow-list">
            ...
            <p>
              ...
              <br />
              返信のない場合はお手数ですがinfo@arttada.comまでお知らせください。
            </p>
          </div>
          <div className="flow-list">
            <h2>２．ご納得いただけましたら先に進みます。</h2>
            <p>
              <span>「家づくりカウンセリングシート＊」</span>
              を記入して頂きます。
            </p>
            <p>
              <span>現地調査</span>及び<span>法的調査</span>
              を行います。また、カウンセリングシートをもとに
              <span>プラン作成 （1案のみ）</span>
              をいたします。2・3週間程でプランと模型、概算金額、スケジュール表をご提出します。この間に見学可能な作品をご案内しております。プラン作成料は10万円となります。
            </p>
            <p>
              ＊このカウンセリングシートをもとに将来のライフスタイルに関するカウンセリング手法を取り入れた家づくりを行います。こちらは
              <span>オリジナルの手法</span>
              です。現在、家づくり、そして「新しい家でどのように暮らすか」といった将来のライフスタイルまでのトータルなアドバイスを行ないます。
            </p>
            <p>
          ...
          <div className="flow-list">
            <h2>３．設計契約を結びます。</h2>
            <p>
              <span>重要事項のご説明を行なったのち、設計契約を結びます。</span>
            </p>
            <p>
              提出物 平面図・断面図・立面図・模型 1/100 ・工事費概算・設計料概算
            </p>
            <p>重要事項説明書</p>
          ...
          <div className="flow-list">
            ...
            <p>おつかれさまでした。</p>
            <p>
              第4回設計監理料お支払い 設計料概算の15%＋実際の工事費による精算
            </p>
